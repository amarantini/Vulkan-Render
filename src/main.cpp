...
int main(int argc, char ** argv) {
    ...
    vec4 myResult = proj * view * mat4::transpose(model) * vec4(0.5f, 0.5f, 0.0f, 1.0);
    ...
    mat4 my_b = proj * view *  mat4::transpose(model);
    std::cout<<"My proj * view * model: "<< mat4::transpose(my_b) <<"\n";
